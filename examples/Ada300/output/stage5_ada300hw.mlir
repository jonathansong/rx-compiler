...
module {
  ...
  func.func @subgraph0(%arg0: memref<128x64xf32, strided<[?, ?], offset: ?>>, %arg1: memref<128xf32, strided<[?], offset: ?>>, %arg2: memref<1x64xf32, strided<[?, ?], offset: ?>>, %arg3: memref<64x128xf32, strided<[?, ?], offset: ?>>, %arg4: memref<64xf32, strided<[?], offset: ?>>) -> memref<1x64xf32> {
    ...
    ada300hw.gmma_mm %alloc_0, %alloc_1, %alloc_2 : memref<1x128xf32>, memref<1x64xf32>, memref<64x128xf32>
    ada300hw.tcsync
    ...
    %2 = ada300hw.vfpwnl %1 {func = #ada300hl.nlfunc<exp>, masked = false, segments = #ada300hl.segments<seg16>} : vector<128xf32> -> vector<128xf32>
    ...
    %4 = ada300hw.vfpwnl %3 {func = #ada300hl.nlfunc<sqrt>, masked = false, segments = #ada300hl.segments<seg16>} : vector<128xf32> -> vector<128xf32>
    ...
    ada300hw.set_gmm_type {act_type = #ada300hl.dtype<fp16>, out_type = #ada300hl.dtype<fp16>, wht_type = #ada300hl.dtype<fp16>}
    ada300hw.set_gmm_iter {blk_cnt_a = 1 : i32, blk_cnt_w = 1 : i32}
    ada300hw.gmma_mm %alloc_5, %alloc_6, %alloc_7 : memref<1x64xf32>, memref<1x128xf32>, memref<128x64xf32>
    ada300hw.tcsync
