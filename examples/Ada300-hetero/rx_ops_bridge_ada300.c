                             ...
                             int64_t M, int64_t N, int64_t K)
{
    ...
    /* rx-ops uses RXOPS_TRUE(1) = success, RXOPS_FALSE(0) / -1 = failure.
     * Normalize to POSIX convention (0 = success) so the host-side rc check
     * in hetero_shmem_host.c works correctly. */
